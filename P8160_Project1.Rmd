...
## Exponential
exp_dist <- simsurv(dist = "gompertz", lambdas = 0.1, gammas = 0.05, 
                    x = covs, betas = c(trt = -0.5), maxt = 5)


## Weibull
weibull_dist <- simsurv(dist <- "weibull", lambdas = 0.1, gammas = 0.05, 
                        x = covs, betas = c(trt = -0.5), maxt = 5)
...
#### Generate multiple Gompertz distribution data
```{r}
